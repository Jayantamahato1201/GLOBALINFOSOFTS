...
export const ContactSection: React.FC<ContactSectionProps> = ({ prefilledScope = '' }) => {
  ...
  const handleFinalBooking = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      try {
        const mailtoLink = `mailto:info@globalinfosofts.com,info@globalinfosofts.com?subject=${emailSubject}&body=${emailBody}`;
              ...
              {stepsMeta.map((step) => {
                ...
                return (
                  ...
                  >
                    {/* Step Circle */}
                    <div
                      className={`w-10 h-10 sm:w-11 sm:h-11 rounded-full flex items-center justify-center transition-all duration-300 ${isActive
                    ...
                    <span
                      className={`mt-2 text-[11px] sm:text-xs font-semibold tracking-wide transition-colors ${isActive
                      ...
                      {[
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1 rounded-lg text-xs font-medium cursor-pointer transition-all ${active
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {['30 Mins', '45 Mins', '60 Mins'].map((dur) => (
                          <button
                            ...
                            className={`py-2 rounded-xl text-xs font-semibold cursor-pointer transition-all ${selectedDuration === dur
                      ...
                      {TIME_SLOTS.map((slot) => {
                        ...
                        return (
                          <button
                            ...
                            className={`p-3 rounded-xl text-xs font-medium text-left cursor-pointer transition-all border ${active
                    ...
                    {PLATFORMS.map((plat) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 rounded-xl border transition-all cursor-pointer flex flex-col justify-between ${active
                        ...
                        >
                          <div className="flex items-center justify-between mb-1.5">
                            ...
                            <span
                              className={`text-[10px] font-mono px-2 py-0.5 rounded-full ${active
                    ...
                    {TOPICS.map((top) => {
                      ...
                      return (
                        <button
                          ...
                          className={`p-3 rounded-xl text-xs text-left transition-all border cursor-pointer ${active
