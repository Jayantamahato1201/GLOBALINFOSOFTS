...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="relative bg-slate-100/90 dark:bg-slate-950/90 border-t border-slate-200/80 dark:border-white/10 text-slate-600 dark:text-slate-400 text-xs backdrop-blur-xl transition-colors duration-300">
      {/* Main Footer Links */}
      <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-16 text-left">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-2 pt-2 text-slate-700 dark:text-slate-300">
              <div className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 text-cyan-600 dark:text-cyan-400 shrink-0 mt-0.5" />
                <span className="text-[11px] leading-tight">Floor 2, House 7, Dayal Apartment, Transport Nagar, Dimna Road, Mango, Jamshedpur, Jharkhand 831012</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors font-mono underline decoration-emerald-500/40 underline-offset-2"
                >
                  +91-9431515806
                </a>
              </div>
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="hover:text-cyan-600 dark:hover:text-cyan-300 transition-colors font-mono"
                >
          ...
          <div className="space-y-3">
            ...
            {subscribed ? (
              <div className="p-3 rounded-xl glass-card text-emerald-700 dark:text-emerald-300 text-xs flex items-center gap-2">
              ...
              <form onSubmit={handleSubscribe} className="space-y-2">
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-3 pr-10 py-2 rounded-xl glass-card text-xs text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:border-cyan-500/50"
                  />
                  <button
                    type="submit"
                    className="absolute right-1.5 top-1/2 -translate-y-1/2 p-1.5 rounded-lg bg-cyan-500 text-white dark:text-slate-950 hover:bg-cyan-600 dark:hover:bg-cyan-400 transition-colors"
                  >
            ...
            <div className="pt-2 text-[11px] text-slate-500 dark:text-slate-500">
        ...
        {/* Bottom Bar */}
        <div className="pt-12 mt-12 border-t border-slate-200/80 dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500 dark:text-slate-400">
          <div>
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={scrollToTop}
              className="p-2 rounded-xl glass-card text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:border-cyan-500/40 transition-all ml-2"
