  ...
  const renderServiceCard = (service: ServiceItem, idx: number) => {
    ...
    const cardThemes = [
      ...
      },
      {
        ...
        glow: 'group-hover:border-pink-500/60 dark:group-hover:border-pink-400/60',
      ...
      },
      {
        ...
        glow: 'group-hover:border-amber-500/60 dark:group-hover:border-amber-400/60',
    ...
    return (
      <div
        ...
        className={`h-full flex flex-col justify-between p-4 sm:p-4.5 rounded-2xl project-card-gradient border border-slate-200/90 dark:border-slate-800/90 ${theme.glow} transition-all duration-300 group cursor-pointer text-left relative overflow-hidden`}
      >
